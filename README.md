...
ARTIFICIAL INTELLIGENCE 2.0 ™ : INSTINCTIVE MIND OBJECT DETECTION A PROXIA (SENSE: VISION_EYE CAMERAS)
...
This is a Google Colab/Jupyter Notebook for (one possible scheme in) developing an OBJECT DETECTION proxia when working with ARTIFICIAL INTELLIGENCE 2.0 ™ 
